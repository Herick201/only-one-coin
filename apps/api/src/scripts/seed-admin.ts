...
// runs over HTTP.
//
// Local/dev credential handoff only — never point this at a staging or
// production DATABASE_URL. Rerunning is safe: signUpEmail fails harmlessly
// if the account already exists, and the role UPDATE always runs.
async function main() {
  try {
