...
export const content = {
  es: {
    ...
    courseDetail: {
      ...
      levelCurrent: "Estás aquí",
      levelView: "Ver este nivel",
      // Nome do nível dentro da seção de níveis, quando o nome de menu não
      // basta: no menu "Inglés" é o idioma; ao lado de "Inglés Intermedio"
      // o mesmo card precisa dizer que é o nível Básico.
      levelNames: {
        "english": "Inglés Básico",
      } as Partial<Record<CourseSlug, string>>,
      // Uma linha por nível: o que é e para quem, sem precisar abrir a página.
      levelSummaries: {
        "english": "Empiezas desde cero · Libros 1–4",
        "english-intermediate": "Continúas después del Básico · Libros 5 y 6",
        "cambridge-b1": "Preparación para el examen Cambridge B1 (PET)",
        "cambridge-b2": "Preparación para el examen Cambridge B2",
      } as Partial<Record<CourseSlug, string>>,
      ...
      modulesLevelPre: "La malla del nivel ",
      modulesLevelPost: ", módulo a módulo",
      moduleLabel: "Módulo",
  ...
  en: {
    ...
    courseDetail: {
      ...
      levelCurrent: "You are here",
      levelView: "See this level",
      levelNames: {
        "english": "Basic English",
      } as Partial<Record<CourseSlug, string>>,
      levelSummaries: {
        "english": "You start from zero · Books 1–4",
        "english-intermediate": "Continues after Basic · Books 5 and 6",
        "cambridge-b1": "Preparation for the Cambridge B1 exam (PET)",
        "cambridge-b2": "Preparation for the Cambridge B2 exam",
      } as Partial<Record<CourseSlug, string>>,
      ...
      modulesLevelPre: "The ",
      modulesLevelPost: " curriculum, module by module",
      moduleLabel: "Module",
  ...
  pt: {
    ...
    courseDetail: {
      ...
      levelCurrent: "Você está aqui",
      levelView: "Ver este nível",
      levelNames: {
        "english": "Inglês Básico",
      } as Partial<Record<CourseSlug, string>>,
      levelSummaries: {
        "english": "Você começa do zero · Livros 1–4",
        "english-intermediate": "Continuação do Básico · Livros 5 e 6",
        "cambridge-b1": "Preparação para o exame Cambridge B1 (PET)",
        "cambridge-b2": "Preparação para o exame Cambridge B2",
      } as Partial<Record<CourseSlug, string>>,
      ...
      modulesLevelPre: "A grade do nível ",
      modulesLevelPost: ", módulo a módulo",
      moduleLabel: "Módulo",
