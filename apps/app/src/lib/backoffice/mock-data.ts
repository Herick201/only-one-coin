...
const students: StudentDetail[] = [
  {
    ...
    activity: [
      ...
      audit({
        ...
        actorName: 'Sistema',
        actorRole: 'coordinator',
        reference: 'Inglés Introductorio',
      }),
      audit({
        id: 'aud_6',
  ...
  },
  {
    ...
    activity: [
      audit({
        ...
        actorName: 'Sistema',
        actorRole: 'coordinator',
        reference: 'guardian_consent_reminder',
      }),
      audit({
        id: 'aud_30',
        action: 'payment_approved',
