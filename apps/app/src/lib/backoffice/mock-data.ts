...
const courses: CourseRow[] = [
  {
    ...
    language: LANGUAGES.en,
    level: 'A1',
    summary: 'Primer nivel de inglés: saludos, presentaciones y conversación cotidiana.',
    minAge: 13,
    modules: 4,
    totalHours: 80,
    certificateRule: 'exam_required',
  ...
  },
  {
    ...
    language: LANGUAGES.en,
    level: 'B1',
    summary: 'Inglés intermedio: fluidez en conversación, lectura y escritura de nivel B1.',
    minAge: 13,
    modules: 2,
    totalHours: 80,
    certificateRule: 'automatic',
  ...
  },
  {
    ...
    language: LANGUAGES.fr,
    level: 'Inicial',
    summary: 'Francés desde cero: pronunciación, saludos y frases de uso diario.',
    minAge: 13,
    modules: 4,
    totalHours: 80,
    certificateRule: 'automatic',
  ...
  },
  {
    ...
    language: LANGUAGES.de,
    level: 'Inicial',
    summary: 'Alemán desde cero: fonética, vocabulario básico y estructuras simples.',
    minAge: 13,
    modules: 4,
    totalHours: 80,
    certificateRule: 'automatic',
  ...
  },
  {
    ...
    language: LANGUAGES.pt,
    level: 'Inicial',
    summary: 'Portugués desde cero: pronunciación, vocabulario y diálogos cotidianos.',
    minAge: 13,
    modules: 4,
    totalHours: 80,
    certificateRule: 'automatic',
  ...
  },
  {
    ...
    language: LANGUAGES.qu,
    level: 'Inicial',
    summary: 'Quechua básico: rimanakuy, vocabulario y escritura para conversar.',
    minAge: 13,
    modules: 3,
    totalHours: 60,
    certificateRule: 'automatic',
  ...
  },
  {
    ...
    level: 'Inicial',
    summary: 'Curso retirado del catálogo; las aulas en curso siguen su ciclo.',
    minAge: 13,
    modules: 3,
    totalHours: 60,
    certificateRule: 'automatic',
...
const staffRoleChanges: StaffRoleChange[] = [
  ...
  },
  {
    ...
    fromRole: 'enrollment_supervisor',
    toRole: 'admin',
    actorName: 'Lucía Ramírez',
    actorRole: 'admin',
  },
